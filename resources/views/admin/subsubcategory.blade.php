...
<div class="row mt-2 mb-0 mx-1 shadow p-1">
  ...
  <div class="row">
          <div class="col-9"> <h5 class="mt-0"> <b> Course  </b> : {{$course_id?$course_id->course_name:"" }} 
...
<div id="success_message"></div>
 ...
 <thead>
       <tr>
              <th  width="10%"> Id </th>
              <th width="15%" class="sorting" data-sorting_type="asc" data-column_name="sub_sub_category_name" style="cursor: pointer" > Sub Sub Category Name
              <span id="sub_sub_category_name_icon" ><i class="fas fa-sort-amount-up-alt"></i></span> </th>
   ...
   <form method="post" id="add_form" enctype="multipart/form-data" >
         ...
         <div class="form-group  my-2">     
	          	<label> <b> Sub Sub Category Name </b> </label>
	           <input name="sub_sub_category_name" id="sub_sub_category_name" type="text"   class="form-control"  required/>
             <p class="text-danger err_sub__sub_category_name"></p>
        </div>


          <div class="form-group  my-2">
              <label for="lname"> <b>Sub category Status </b> </label>
                   <select class="form-select" name="sub_sub_category_status" id="sub_sub_category_status" aria-label="Default select example">
...
<form method="post" id="edit_form" enctype="multipart/form-data" >
   <div class="modal-body">
      ...
      <div class="form-group  my-2">
	      	<label><b> Sub SubCategory  Name</b></label>
	        <input name="sub_sub_category_name" id="edit_sub_sub_category_name" type="text"   class="form-control"  required/>
          <p class="text-danger err_sub_sub_category_name"></p>
     </div>


       <div class="form-group  my-2">
         <label for="lname">Sub Sub Category Status </label>
                <select class="form-select" name="sub_sub_category_status" id="edit_sub_sub_category_status" aria-label="Default select example"  >
                      <option value="1"> Active</option>
                      <option value="0"> Inactive </option>
                </select>
       </div>     
...
<script src="{{ asset('js/subsubcategory.js') }}"></script>
