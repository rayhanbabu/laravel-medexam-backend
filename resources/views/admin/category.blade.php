...
<div class="row mt-2 mb-0 mx-1 shadow p-1">
  ...
  <div class="row">
          <div class="col-6"> <h5 class="mt-0"> Category  of {{$course_id?$course_id->course_name:"" }} </h5></div>
                     <div class="col-3">
 ...
 <thead>
   ...
   <form method="post" id="add_form" enctype="multipart/form-data" >
         ...
         <div class="form-group  my-2">     
             ...
             <p class="text-danger err_category_name"></p>
        </div>
...
<form method="post" id="edit_form" enctype="multipart/form-data" >
   <div class="modal-body">
      ...
      <div class="form-group  my-2">
	        ...
	        <input name="category_name" id="edit_category_name" type="text"   class="form-control"  required/>
          <p class="text-danger err_category_name"></p>
     </div>


       <div class="form-group  my-2">
         <label for="lname"> Category Status </label>
