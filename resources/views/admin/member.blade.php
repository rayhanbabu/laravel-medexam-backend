      ...
      <form  method="POST" id="add_employee_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-12 ">
                <label for="roll"> Current Address </label>
            ...
            <div class="col-lg-12 ">
                ...
                <input type="text" name="permanet_address" id="permanet_address" class="form-control" placeholder="" >
                <p class="text-danger error_member_name"></p>
              </div>
        ...
        <div class="modal-body p-4 bg-light">
          ...
          <div class="col-lg-6">
            ...
            <div class="col-lg-12 ">
             ...
             <div class="col-lg-12 ">
                <label for="roll"> Permanent Address </label>
                <input type="text" name="permanet_address" id="edit_permanet_address" class="form-control" placeholder="" >
                <p class="text-danger error_member_name"></p>
              </div>

              <div class="col-lg-6 ">
                  <label class="">  Status  <span style="color:red;"> * </span> </label>
                     <select class="form-select form-select-sm" name="member_status" id="edit_member_status" aria-label="Default select example">
